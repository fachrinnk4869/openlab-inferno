...
cfg.model.topology_path = os.path.join(
    cfg.deca_dir, 'data', 'head_template.obj')
...
cfg.model.flame_model_path = os.path.join(
    cfg.deca_dir, 'data', 'male_model.pkl')
...
cfg.model.face_mask_path = os.path.join(
    cfg.deca_dir, 'data', 'uv_face_mask.png')
cfg.model.face_eye_mask_path = os.path.join(
    cfg.deca_dir, 'data', 'uv_face_eye_mask.png')
cfg.model.mean_tex_path = os.path.join(
    cfg.deca_dir, 'data', 'mean_texture.jpg')
cfg.model.tex_path = os.path.join(
    cfg.deca_dir, 'data', 'FLAME_albedo_from_BFM.npz')
...
# default use axis angle, another option: euler. Note that: aa is not stable in the beginning
cfg.model.jaw_type = 'aa'
# face recognition model
cfg.model.fr_model_path = os.path.join(
    cfg.deca_dir, 'data', 'resnet50_ft_weight.pkl')
